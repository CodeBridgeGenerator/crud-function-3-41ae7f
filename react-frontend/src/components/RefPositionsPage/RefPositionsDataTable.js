...
const RefPositionsDataTable = ({ items, onEditRow, onRowDelete, onRowClick }) => {
    ...
    const checkboxTemplate5 = (rowData, { rowIndex }) => <Checkbox checked={rowData.direct}  ></Checkbox>
    const checkboxTemplate6 = (rowData, { rowIndex }) => <Checkbox checked={rowData.ishead}  ></Checkbox>
    ...
    return (
        ...
        currentPageReportTemplate="{first} to {last} of {totalRecords}" paginatorLeft={paginatorLeft} paginatorRight={paginatorRight} rowClassName="cursor-pointer">
            ...
            <Column field="direct" header="direct" body={checkboxTemplate5} style={{ minWidth: "8rem" }} />
            <Column field="ishead" header="ishead" body={checkboxTemplate6} style={{ minWidth: "8rem" }} />
