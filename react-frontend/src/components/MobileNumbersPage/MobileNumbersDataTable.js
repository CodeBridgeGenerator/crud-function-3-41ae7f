...
const MobileNumbersDataTable = ({ items, onEditRow, onRowDelete, onRowClick }) => {
    const dt = useRef(null);
     
    const inputTemplate1 = (rowData, { rowIndex }) => <InputText value={rowData.mobileno}  />
    const inputTemplate2 = (rowData, { rowIndex }) => <InputText value={rowData.country}  />
    const pTemplate3 = (rowData, { rowIndex }) => <p >{rowData.operator}</p>
    const inputTemplate4 = (rowData, { rowIndex }) => <InputText value={rowData.mobile}  />
    ...
    return (
        ...
        currentPageReportTemplate="{first} to {last} of {totalRecords}" paginatorLeft={paginatorLeft} paginatorRight={paginatorRight} rowClassName="cursor-pointer">
            <Column field="mobileno" header="mobileno" body={inputTemplate1} style={{ minWidth: "8rem" }} />
            <Column field="country" header="country" body={inputTemplate2} style={{ minWidth: "8rem" }} />
            <Column field="operator" header="Operator" body={pTemplate3} style={{ minWidth: "8rem" }} />
            <Column field="mobile" header="mobile" body={inputTemplate4} style={{ minWidth: "8rem" }} />
...
export default MobileNumbersDataTable;