...
const SingleMobileNumbersPage = (props) => {
    ...
    return (
        <div className="col-12 flex flex-column align-items-center">
            ...
            <div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-primary">mobileno</label><p className="m-0 ml-3" >{_entity?.mobileno}</p></div>
                    <div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-primary">country</label><p className="m-0 ml-3" >{_entity?.country}</p></div>
                    <div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-primary">Operator</label><p className="" >{_entity?.operator}</p></div>
                    <div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-primary">mobile</label><p className="m-0 ml-3" >{_entity?.mobile}</p></div>
