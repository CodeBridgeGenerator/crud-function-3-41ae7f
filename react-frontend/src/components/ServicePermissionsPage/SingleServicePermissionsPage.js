...
const SingleServicePermissionsPage = (props) => {
    ...
    useEffect(() => {
        ...
        client
            ...
            .get(urlParams.singleServicePermissionsId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
    ...
    }, [props,urlParams.singleServicePermissionsId]);
        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-10">
                <div className="flex align-items-center justify-content-start">
                    ...
                    <h3 className="m-0">ServicePermissions</h3>
                </div>
                <p>servicePermissions/{urlParams.singleServicePermissionsId}</p>
            ...
            <div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-primary">Service Id</label><p className="" >{_entity?.serviceId}</p></div>
                    ...
                    <div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-primary">updateany</label><i className={`pi ${_entity?.updateany?"pi-check": "pi-times"}`}  ></i></div>
                    <div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-primary">updateown</label><i className={`pi ${_entity?.updateown?"pi-check": "pi-times"}`}  ></i></div>
...
export default connect(mapState, mapDispatch)(SingleServicePermissionsPage);
