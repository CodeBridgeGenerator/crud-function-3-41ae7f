...
const ServicePermissionProjectLayoutPage = (props) => {
  return (
    <UserLayout>
      <div className="pt-2">
        <div className="card p-0 overflow-hidden ">
          ...
          >
            <div className="flex align-items-center text-white">
              ...
              Service Permissions  {" > " + props.selectedUser?.name} 
              </p>
            </div>
          </div>
...
export default connect(mapState, mapDispatch)(ServicePermissionProjectLayoutPage);