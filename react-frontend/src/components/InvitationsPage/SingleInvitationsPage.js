    ...
    return (
        <div className="col-12 flex flex-column align-items-center">
            ...
            <div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-primary">Email</label><p className="" >{_entity?.email}</p></div>
                    <div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-primary">accepted</label><i className={`pi ${_entity?.accepted?"pi-check": "pi-times"}`}  ></i></div>
                    <div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-primary">sentStatus</label><i className={`pi ${_entity?.sentStatus?"pi-check": "pi-times"}`}  ></i></div>
