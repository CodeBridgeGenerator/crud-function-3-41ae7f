...
const CompaniesDataTable = ({ items, onEditRow, onRowDelete, onRowClick }) => {
    ...
    const checkboxTemplate9 = (rowData, { rowIndex }) => <Checkbox checked={rowData.isDefault}  ></Checkbox>
    ...
    return (
        ...
        currentPageReportTemplate="{first} to {last} of {totalRecords}" paginatorLeft={paginatorLeft} paginatorRight={paginatorRight} rowClassName="cursor-pointer">
            ...
            <Column field="isDefault" header="isDefault" body={checkboxTemplate9} style={{ minWidth: "8rem" }} />
