...
const PositionRoleDepartmentDataTable = ({ items, onEditRow, onRowDelete, onRowClick }) => {
    const dt = useRef(null);
     
    const calendarTemplate4 = (rowData, { rowIndex }) => <Calendar dateFormat="dd/mm/yy" placeholder={"dd/mm/yy"} value={new Date(rowData.start)} ></Calendar>
    const calendarTemplate5 = (rowData, { rowIndex }) => <Calendar dateFormat="dd/mm/yy" placeholder={"dd/mm/yy"} value={new Date(rowData.end)} ></Calendar>
    ...
    return (
        ...
        currentPageReportTemplate="{first} to {last} of {totalRecords}" paginatorLeft={paginatorLeft} paginatorRight={paginatorRight} rowClassName="cursor-pointer">
            <Column field="start" header="start" body={calendarTemplate4} style={{ minWidth: "8rem" }} />
            <Column field="end" header="end" body={calendarTemplate5} style={{ minWidth: "8rem" }} />
...
export default PositionRoleDepartmentDataTable;