...
const FieldPermissionsCreateDialogComponent = (props) => {
    ...
    const onSave = async () => {
        ...
        const result = await client.service("fieldPermissions").create(_data);
        ...
        props.onHide();
        props.alert({ type: "success", title: "Create info", message: "Info fieldPermissions updated successfully" });
    ...
    return (
        <Dialog header="Create Field Permissions" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
            ...
            style={{ maxWidth: "55vw" }} role="fieldPermissions-create-dialog-component">
            ...
            <div className="col-12 md:col-6 field mt-5">
            <span className="align-items-center">
                <label htmlFor="patchany">patchany:</label>
                <Checkbox id="patchany" checked={_entity?.patchany} onChange={ (e) => setValByKey("patchany", e.checked)}  ></Checkbox>
            </span>
            </div>
            <div className="col-12 md:col-6 field mt-5">
            <span className="align-items-center">
                <label htmlFor="patchown">patchown:</label>
                <Checkbox id="patchown" checked={_entity?.patchown} onChange={ (e) => setValByKey("patchown", e.checked)}  ></Checkbox>
            </span>
            </div>
            <div className="col-12 md:col-6 field mt-5">
            <span className="align-items-center">
