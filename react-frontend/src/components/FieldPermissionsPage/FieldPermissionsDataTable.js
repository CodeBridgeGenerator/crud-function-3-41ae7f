...
const FieldPermissionsDataTable = ({ items, onEditRow, onRowDelete, onRowClick }) => {
    ...
    const checkboxTemplate4 = (rowData, { rowIndex }) => <Checkbox checked={rowData.read}  ></Checkbox>
    const checkboxTemplate5 = (rowData, { rowIndex }) => <Checkbox checked={rowData.create}  ></Checkbox>
    const checkboxTemplate6 = (rowData, { rowIndex }) => <Checkbox checked={rowData.patchany}  ></Checkbox>
    const checkboxTemplate7 = (rowData, { rowIndex }) => <Checkbox checked={rowData.patchown}  ></Checkbox>
    const checkboxTemplate8 = (rowData, { rowIndex }) => <Checkbox checked={rowData.deleteany}  ></Checkbox>
    const checkboxTemplate9 = (rowData, { rowIndex }) => <Checkbox checked={rowData.deleteown}  ></Checkbox>
    ...
    return (
        ...
        currentPageReportTemplate="{first} to {last} of {totalRecords}" paginatorLeft={paginatorLeft} paginatorRight={paginatorRight} rowClassName="cursor-pointer">
            ...
            <Column field="read" header="read" body={checkboxTemplate4} style={{ minWidth: "8rem" }} />
            <Column field="create" header="create" body={checkboxTemplate5} style={{ minWidth: "8rem" }} />
            <Column field="patchany" header="patchany" body={checkboxTemplate6} style={{ minWidth: "8rem" }} />
            <Column field="patchown" header="patchown" body={checkboxTemplate7} style={{ minWidth: "8rem" }} />
            <Column field="deleteany" header="deleteany" body={checkboxTemplate8} style={{ minWidth: "8rem" }} />
            <Column field="deleteown" header="deleteown" body={checkboxTemplate9} style={{ minWidth: "8rem" }} />
