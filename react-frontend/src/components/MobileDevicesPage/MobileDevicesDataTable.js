...
const MobileDevicesDataTable = ({ items, onEditRow, onRowDelete, onRowClick }) => {
    const dt = useRef(null);
     
    const pTemplate2 = (rowData, { rowIndex }) => <p >{rowData.osff}</p>
    const pTemplate3 = (rowData, { rowIndex }) => <p >{rowData.version}</p>
    const pTemplate4 = (rowData, { rowIndex }) => <p >{rowData.sdk}</p>
    ...
    return (
        ...
        currentPageReportTemplate="{first} to {last} of {totalRecords}" paginatorLeft={paginatorLeft} paginatorRight={paginatorRight} rowClassName="cursor-pointer">
            <Column field="osff" header="Os" body={pTemplate2} style={{ minWidth: "8rem" }} />
            <Column field="version" header="Version" body={pTemplate3} style={{ minWidth: "8rem" }} />
            <Column field="sdk" header="Sdk" body={pTemplate4} style={{ minWidth: "8rem" }} />
...
export default MobileDevicesDataTable;