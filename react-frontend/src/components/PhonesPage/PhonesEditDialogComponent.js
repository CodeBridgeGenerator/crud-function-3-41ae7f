...
const PhonesCreateDialogComponent = (props) => {
    ...
    return (
        <Dialog header="Edit Phones" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto"
            style={{ maxWidth: "55vw" }} role="phones-edit-dialog-component">
            ...
            <span className="align-items-center">
                ...
                <InputText id="number" type="text" value={_entity?.number} onChange={(e) => setValByKey("number", e.target.value)}  />
            </span>
            </div>
            <div className="col-12 md:col-6 field mt-5">
            <span className="align-items-center">
