...
const SingleProfileStatusPage = (props) => {
    ...
    useEffect(() => {
        ...
        client
            ...
            .get(urlParams.singleProfileStatusId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
    ...
    }, [props,urlParams.singleProfileStatusId]);
        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-10">
                <div className="flex align-items-center justify-content-start">
                    ...
                    <h3 className="m-0">ProfileStatus</h3>
                </div>
                <p>profileStatus/{urlParams.singleProfileStatusId}</p>
...
export default connect(mapState, mapDispatch)(SingleProfileStatusPage);
