...
const UserCompaniesDataTable = ({ items, onEditRow, onRowDelete, onRowClick }) => {
    ...
    const calendarTemplate2 = (rowData, { rowIndex }) => <Calendar dateFormat="dd/mm/yy" placeholder={"dd/mm/yy"} value={new Date(rowData.effectiveDate)} ></Calendar>
    const calendarTemplate3 = (rowData, { rowIndex }) => <Calendar dateFormat="dd/mm/yy" placeholder={"dd/mm/yy"} value={new Date(rowData.endDate)} ></Calendar>
    ...
    return (
        ...
        currentPageReportTemplate="{first} to {last} of {totalRecords}" paginatorLeft={paginatorLeft} paginatorRight={paginatorRight} rowClassName="cursor-pointer">
            <Column field="effectiveDate" header="effectiveDate" body={calendarTemplate2} style={{ minWidth: "8rem" }} />
            <Column field="endDate" header="endDate" body={calendarTemplate3} style={{ minWidth: "8rem" }} />
