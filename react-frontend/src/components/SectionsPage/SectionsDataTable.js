...
const SectionsDataTable = ({ items, onEditRow, onRowDelete, onRowClick }) => {
    const dt = useRef(null);
     
    const pTemplate3 = (rowData, { rowIndex }) => <p >{rowData.section}</p>
    const checkboxTemplate4 = (rowData, { rowIndex }) => <Checkbox checked={rowData.isHead}  ></Checkbox>
    const checkboxTemplate5 = (rowData, { rowIndex }) => <Checkbox checked={rowData.isDefault}  ></Checkbox>
    ...
    return (
        ...
        currentPageReportTemplate="{first} to {last} of {totalRecords}" paginatorLeft={paginatorLeft} paginatorRight={paginatorRight} rowClassName="cursor-pointer">
            <Column field="section" header="Section" body={pTemplate3} style={{ minWidth: "8rem" }} />
            <Column field="isHead" header="isHead" body={checkboxTemplate4} style={{ minWidth: "8rem" }} />
            <Column field="isDefault" header="isDefault" body={checkboxTemplate5} style={{ minWidth: "8rem" }} />
