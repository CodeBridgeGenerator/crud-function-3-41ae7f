...
const SectionsFakerDialogComponent = (props) => {
    ...
    const [loading, setLoading] = useState(false);
                ...
                const [branchIdIds, setbranchIdIds] = useState();
...
client
    ...
    const onRun = async () => {
        let fakeData = sectionsFakerFactory(fakerCount,companyIdIds,branchIdIds,departmentIdIds);
